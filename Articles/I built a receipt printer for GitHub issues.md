...
source: https://aschmelyun.com/blog/i-built-a-receipt-printer-for-github-issues/
...
If my user(s) aren't part of the _dialout_ group, I try to add them to it now:
